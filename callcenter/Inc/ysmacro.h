...
#define YSLUCK_INIT                 LUCK_INIT
#define YSLUCK_INIT2                LUCK_INIT2
#define YSLUCK_INIT_NOT             LUCK_INIT_NOT
#define YSLUCK_ISINIT               LUCK_ISINIT
...
#define YSRTN_CMP                  RTNCODE_CMP
#define YSRTN_CMP1                 RTNCODE_CMP1
#define YSRTN_CMPOKER              RTNCODE_CMPOKER
#define YSRTN_CMPBOOL              RTNCODE_CMPBOOL
