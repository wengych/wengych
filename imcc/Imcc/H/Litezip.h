...
// Function to set callback for ZipAdd* functions
typedef LRESULT (CALLBACK* lpfnCallBack)(DWORD dwResvered);
DWORD WINAPI ZipSetCallBack(HZIP hz, lpfnCallBack lpfn);
#define ZIPSETCALLBACKNAME "ZipSetCallBack"
typedef DWORD WINAPI ZipSetCallBackPtr(HZIP hz, lpfnCallBack lpfn);
