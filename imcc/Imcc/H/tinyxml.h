...
public:
	...
	*/
	...
	/**	All TinyXml classes can print themselves to a memory buffer.
		This is a formatted print, and will insert tabs and newlines.
		(For an unformatted stream, use the << operator.)
		add by brian.sheng
	*/
	virtual void Sprint( char* cbuf, int depth ) const = 0;
...
public:
	...
	*/
	...
	// [internal use]
	virtual void Sprint( char* cbuf, int depth ) const;
