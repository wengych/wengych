...
{
	/**
	 * generated bindable wrapper for property colorPicker (public)
	 * - generated setter
	 * - generated getter
	 * - original public var 'colorPicker' moved to '_885706193colorPicker'
	 */

    [Bindable(event="propertyChange")]
    public function get colorPicker():mx.controls.ColorPicker
    {
        return this._885706193colorPicker;
    }

    public function set colorPicker(value:mx.controls.ColorPicker):void
    {
    	var oldValue:Object = this._885706193colorPicker;
        if (oldValue !== value)
        {
            this._885706193colorPicker = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "colorPicker", oldValue, value));
        }
    }
