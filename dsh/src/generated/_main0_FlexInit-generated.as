...
public class _main0_FlexInit
{
   ...
   public static function init(fbs:IFlexModuleFactory):void
   {
      ...
      if (flash.net.getClassByAlias("flex.messaging.io.ObjectProxy") == null){
          ...
          flash.net.registerClassAlias("flex.messaging.io.ObjectProxy", mx.utils.ObjectProxy); }
      var styleNames:Array = ["fontWeight", "modalTransparencyBlur", "rollOverColor", "textRollOverColor", "verticalGridLineColor", "backgroundDisabledColor", "textIndent", "barColor", "fontSize", "itemSelectionColor", "kerning", "adjustedRadius", "itemDisabledColor", "footerColors", "textAlign", "disabledIconColor", "fontStyle", "dropdownBorderColor", "modalTransparencyDuration", "textSelectedColor", "axisTitleStyleName", "horizontalGridLineColor", "todayColor", "selectionColor", "modalTransparency", "fontGridFitType", "selectionDisabledColor", "disabledColor", "fontAntiAliasType", "modalTransparencyColor", "alternatingItemColors", "itemRollOverColor", "leading", "shadowColor", "iconColor", "dropShadowColor", "themeColor", "letterSpacing", "fontFamily", "color", "fontThickness", "errorColor", "headerColors", "fontSharpness", "textDecoration"];
