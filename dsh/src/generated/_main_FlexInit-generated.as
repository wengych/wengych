...
public class _main_FlexInit
{
   ...
   public static function init(fbs:IFlexModuleFactory):void
   {
      ...
      if (flash.net.getClassByAlias("flex.messaging.io.ObjectProxy") == null){
          ...
          flash.net.registerClassAlias("flex.messaging.io.ObjectProxy", mx.utils.ObjectProxy); }
      var styleNames:Array = ["fontWeight", "modalTransparencyBlur", "backgroundDisabledColor", "verticalGridLineColor", "barColor", "itemSelectionColor", "itemDisabledColor", "textAlign", "disabledIconColor", "fontStyle", "depthColors", "modalTransparencyDuration", "axisTitleStyleName", "horizontalGridLineColor", "todayColor", "fontGridFitType", "shadowCapColor", "modalTransparencyColor", "disabledColor", "alternatingItemColors", "dropShadowColor", "fontThickness", "fontSharpness", "textDecoration", "dividerColor", "textRollOverColor", "rollOverColor", "textIndent", "fontSize", "kerning", "adjustedRadius", "footerColors", "dropdownBorderColor", "textSelectedColor", "modalTransparency", "selectionColor", "fontAntiAliasType", "selectionDisabledColor", "leading", "itemRollOverColor", "shadowColor", "iconColor", "themeColor", "letterSpacing", "fontFamily", "highlightColor", "color", "errorColor", "headerColors"];
