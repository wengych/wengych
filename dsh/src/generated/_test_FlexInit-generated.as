...
public class _test_FlexInit
{
   ...
   public static function init(fbs:IFlexModuleFactory):void
   {
      ...
      if (flash.net.getClassByAlias("flex.messaging.io.ObjectProxy") == null){
          ...
          flash.net.registerClassAlias("flex.messaging.io.ObjectProxy", mx.utils.ObjectProxy); }
      var styleNames:Array = ["fontWeight", "modalTransparencyBlur", "rollOverColor", "textRollOverColor", "verticalGridLineColor", "backgroundDisabledColor", "textIndent", "barColor", "fontSize", "kerning", "footerColors", "textAlign", "disabledIconColor", "fontStyle", "dropdownBorderColor", "depthColors", "modalTransparencyDuration", "textSelectedColor", "horizontalGridLineColor", "selectionColor", "modalTransparency", "shadowCapColor", "fontGridFitType", "selectionDisabledColor", "disabledColor", "fontAntiAliasType", "modalTransparencyColor", "alternatingItemColors", "leading", "shadowColor", "iconColor", "dropShadowColor", "themeColor", "letterSpacing", "fontFamily", "highlightColor", "color", "fontThickness", "errorColor", "headerColors", "fontSharpness", "textDecoration", "dividerColor"];
