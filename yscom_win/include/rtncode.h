...
#define RTNCODE_ERAPP_LOADSERV    (RTNCODE_ERBASE_APP-35)
#define RTNCODE_ERAPP_LOADSERV2   (RTNCODE_ERBASE_APP-36)
#define RTNCODE_ERAPP_SAVESERV    (RTNCODE_ERBASE_APP-37)
#define RTNCODE_ERAPP_EXISTSERV   (RTNCODE_ERBASE_APP-38)
