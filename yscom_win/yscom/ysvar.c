...
BOOL  YSVarBinMalloc2(void *Var,INT32 L)
{
    return FEVarBinMalloc2(Var,L);
}
...
BOOL  YSVarStringMalloc2(void *Var,INT32 L)
{
    return FEVarStringMalloc2(Var,L);
}
...
void *YSVarHashGetLinkByIdx(void *Var,INT32 Idx)
{
    return FEVarHashGetLinkByIdx(Var,Idx);
}

INT32 YSVarHashGetBase(void *Var)
{
    return FEVarHashGetBase(Var);
}
